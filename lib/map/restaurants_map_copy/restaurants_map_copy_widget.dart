...
import 'restaurants_map_copy_model.dart';
export 'restaurants_map_copy_model.dart';

class RestaurantsMapCopyWidget extends StatefulWidget {
  const RestaurantsMapCopyWidget({super.key});

  @override
  State<RestaurantsMapCopyWidget> createState() =>
      _RestaurantsMapCopyWidgetState();
}

class _RestaurantsMapCopyWidgetState extends State<RestaurantsMapCopyWidget> {
  late RestaurantsMapCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => RestaurantsMapCopyModel());

    logFirebaseEvent('screen_view',
        parameters: {'screen_name': 'restaurantsMapCopy'});
    // On page load action.
  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final restaurantsMapCopyNearbyRestaurantsResponse = snapshot.data!;
                        ...
                        child: Container(
                          ...
                          child: custom_widgets.CustomRestaurantsMap(
                            ...
                            restaurants: functions
                              ...
                              restaurantsMapCopyNearbyRestaurantsResponse
                                  .jsonBody,
                              r'''$''',
                              true,
                            )),
