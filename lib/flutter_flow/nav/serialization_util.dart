  ...
  try {
    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          case VideoCommentsRow:
            return VideoCommentsRow(data);
          case RestaurantSpecialitiesRow:
            return RestaurantSpecialitiesRow(data);
          case RestaurantsRow:
            return RestaurantsRow(data);
          case FavorisRow:
            return FavorisRow(data);
          case VideosRow:
            return VideosRow(data);
          case RestaurantVideosRow:
            return RestaurantVideosRow(data);
          case RestaurantCommentsRow:
            return RestaurantCommentsRow(data);
          case VideoLikesRow:
