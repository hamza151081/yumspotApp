...
import '/trash/search_element/search_element_widget.dart';
...
class _SearchWidgetState extends State<SearchWidget> {
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          _model.textController?.text = '32/7 travis road, new jersey';
        }));
  }
                      ...
                      child: Builder(
                        builder: (context) {
                          ...
                          return ListView.builder(
                            ...
                            itemBuilder: (context, restauIndex) {
                              final restauItem = restau[restauIndex];
                              return Container(
                                width: 357.0,
                                decoration: BoxDecoration(
                                  color: FlutterFlowTheme.of(context)
                                ...
                                child: SearchElementWidget(
                                  key: Key(
                                      'Keyb38_${restauIndex}_of_${restau.length}'),
                                ),
                              );
                            },
                          );
